...
export class RuntimeVariable {
  ...
  func_1387360128851968 = (args, extra) => {
    this.workspace.initEventVariable(1387360128851968);
    const flowDsl = this.workspace.findEventDslById(1387360128851968);
    if (!flowDsl) {
      return undefined;
    }
